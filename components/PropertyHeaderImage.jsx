...
import { FaLocationDot, FaBed, FaBath, FaRulerCombined, FaCheck, FaBookmark, FaShare, FaPaperPlane } from "react-icons/fa";
                        ...
                        <main>
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                                ...
                                <div className="flex justify-center gap-4 text-blue-500 mb-4 text-xl space-x-9">
                                    ...
                                    <p>
                                        <FaRulerCombined /> 1,500 <span className="hidden sm:inline">sqft</span>
                                    </p>
                                </div>
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                                ...
                                <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 list-none">
                                    {["Wifi", "Full kitchen", "Washer & Dryer", "Free Parking", "Hot Tub", "24/7 Security", "Wheelchair Accessible", "Elevator Access", "Dishwasher", "Gym/Fitness Center", "Air Conditioning", "Balcony/Patio", "Smart TV", "Coffee Maker"].map((item, idx) => (
